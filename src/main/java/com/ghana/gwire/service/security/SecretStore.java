...
/**
 * P0 local secrets store: {@code ~/.gwire/secrets.properties} with mode {@code 0600}.
 *
 * <p>Threat model is world-readable home files / other local users — not same-UID attackers.
 * No AES/KDF required for Phase 10. Env vars always win over this store.
 */
public final class SecretStore {
    ...
    public SecretStore(Path secretsPath) {
