...
/**
 * Builds a sample three-bedroom Ghanaian residential project for demos and packaging.
 *
 * <p>Layout is a simplified single-storey bungalow (~12 m × 10 m) with living, dining,
 * kitchen, three bedrooms, bathroom, store, and veranda — typical of common Ghana
 * housing stock for L.I. 2008 domestic wiring exercises.
 */
